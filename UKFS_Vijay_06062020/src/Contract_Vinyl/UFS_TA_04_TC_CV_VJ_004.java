...
public class UFS_TA_04_TC_CV_VJ_004 {
	...
	public static void main(String[] args) {
		...
		WebElement subMenuOption = driver.findElement(By.xpath("//span[@style='color:;  ' and text()='ALTRO STRONGHOLD 30']"));
		
		actions.moveToElement(subMenuOption).perform();
		System.out.println("Mouse hover over 'ALTRO STRONGHOLD 30' is done ");
		
		subMenuOption.click();
		
		String pageTitle = driver.getTitle();
		
		if (pageTitle.contains("ALTRO STRONGHOLD 30")) {
